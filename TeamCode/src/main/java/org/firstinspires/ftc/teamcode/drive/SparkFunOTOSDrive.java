...
public class SparkFunOTOSDrive extends MecanumDrive {
    public static class Params {
        ...
        public SparkFunOTOS.Pose2D offset = new SparkFunOTOS.Pose2D(-6.2297, -0.1442, Math.toRadians(90));
        ...
        public double linearScalar = 0.98417964034;
        public double angularScalar = 0.7669;
    }
    ...
    public SparkFunOTOSDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        lazyImu = new LazyImu(hardwareMap, "i", new RevHubOrientationOnRobot(
